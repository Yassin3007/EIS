...
<div class="row mb-2">
  <div class="col-sm-6">
    <h1>{{Request::is('*about-us-sections*') ? "About Us Sections" : 'Interest Projects'}}</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('dashboard.view')}}">Dashboard</a></li>
              <li class="breadcrumb-item">{{Request::is('*about-us-sections*') ? "About Us Sections" : "Interest Projects"}}</li>
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        ...
        <a class="btn btn-primary" style="float: right" href="{{Request::is('*about-us-sections*') ? route('about-us-sections.create') : route('office.create')}}">Add</a>
      </div>
      <div class="card-body">
        <table id="tableContainer"  class="table table-bordered table-striped text-center">
          ...
          @foreach ($office as $life_style)
              <tr class="odd gradeX"  id="{{$life_style->id}}" >
                ...
                <td>
                  <a class="btn btn-info" href="{{Request::is('*about-us-sections*') ? route('about-us-sections.edit',$life_style->id) : route('office.edit',$life_style->id)}}">Edit</a>
...
<script type="text/javascript">
  $(".switch").change(function(){
     console.log('we are done');
      ...
      var id = $(this).parents("tr").attr("id");
       swal.fire({
              title: value==0?"you just active this Interest Projects ":"you just deactive this Interest Projects",
              text: value==0?"this Interest Projects will display in forms  ":'this Interest Projects will not be display in forms  ',
              type: "success",
              ...
              if (result.isConfirmed) {
                  $.ajax({
                      url: '{{url("/dashboard/office/status")}}'+'/'+id,
                      type: 'POST',
                      data: {
