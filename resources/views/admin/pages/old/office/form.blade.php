...
@section('content_header')
  <div class="row mb-2">
    <div class="col-sm-6">
      <h1>{{$office->id?'Edit':' Create'}} Interest Projects</h1>
    </div>
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="{{route('dashboard.view')}}">Dashboard</a></li>
        <li class="breadcrumb-item"><a href="{{route('office.index')}}">Interest Projects</a></li>
        <li class="breadcrumb-item active">Interest Projects Form</li>
      </ol>
    </div>
  </div>
@endsection
    ...
    <div class="col-md-12">
      <div class="card card-create">
        <div class="card-header">
          <h3 class="card-title">{{$office->id?'Edit':' Add'}} Interest Projects</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <form action="{{$office->id?route('office.update',$office->id):route('office.store')}}" method="POST"
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" value="{{$office->name}}" class="form-control"
                         placeholder="Enter ...">
                </div>
              </div>
              ...
              {{-- <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="pref" value="{{$office->pref}}" class="form-control"
                         placeholder="Enter ...">
                </div>
              </div>
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="date" value="{{$office->date}}" class="form-control"
                         placeholder="Enter ...">
                </div>
              </div>
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <textarea id="summernote_en" rows="5" class="form-control" name="content"
                            required>{{ $office->content ?? old('content') }}</textarea>
                </div>
              </div> --}}
              ...
              {{-- <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" name="alt_en" maxlength="90"
                         value="{{$office->images->first()?$office->images->first()->alt_en:old('alt_en') }}"
              ...
              {{-- <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" name="alt_ar" maxlength="90"
                         value="{{$office->images->first()?$office->images->first()->alt_ar:old('alt_ar') }}"
                         class="form-control" placeholder="Enter ..." required>
                </div>
              </div> --}}
              {{-- <div class="col-sm-6">
              ...
              @if (count($office->images))
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="my-3">office Image</label>
                    <div class="d-flex flex-wrap ">
                      @if($image = $office->images->last())
