  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        ...
        <a class="btn btn-primary" style="float: right" href="{{route('roles.create')}}">Add User</a>
        @endif
      </div>
      <div class="card-body">
        <table id="tableContainer"  class="table table-bordered table-striped text-center">
          ...
          <tbody>
            ...
            <tr class="odd gradeX"  id="{{$role->id}}"  >
                   ...
                   {{-- <td><img src="{{$role->profileImage??asset("assets\admin.png")}}" class="img elevation-2" height="50" alt="User Image"></td> --}}
                   @if (auth()->user()->roles->first()->name==='SuperAdmin')
                   <td>
