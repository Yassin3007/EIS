@extends('layouts.site')
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">المقالات</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="{{route('index')}}">الرئيسيه</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0"> المقالات</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
                ...
                <div class="row pb-3 px-3">
                    @foreach($articles as $article)
                        <div class="wrapper d-flex flex-column pb-5">
                            ...
                            <a href="{{route('article_details',$article->id)}}" class="btn btn-primary py-2 px-4 align-self-start">إقرأ
                                المزيد</a>
                        </div>
