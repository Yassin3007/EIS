        ...
        <div class="carousel-inner" >
            @if($banners->isNotEmpty())
                <div class="carousel-item active " >
                    <img class="img-fluid" loading="lazy" src="{{$banners->first()->projectImages('banner_image')->first()?$banners->first()->projectImages('banner_image')->first()->full_url:asset("assets/admin.png")}}" alt="Image">
            ...
            @foreach($banners->skip(1) as $banner)
                ...
                <div class="carousel-item " >
                    <img class="img-fluid" loading="lazy" src="{{$banner->projectImages('banner_image')->first()?$banner->projectImages('banner_image')->first()->full_url:asset("assets/admin.png")}}" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 700px;">
